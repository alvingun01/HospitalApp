...
class CustomUserManager(BaseUserManager):
    ...
    def create_user(self, email, password=None, **extra_fields):
        ...
        # Populate username with email to support third-party packages 
        # or Django internal parts relying on the username attribute.
...
class CustomUser(AbstractUser):
    # Set username to match email, making it unique and optional
...
class DoctorProfile(models.Model):
    ...
    def __str__(self):
        return f"Doctor: {self.user.get_full_name() or self.user.email}"
...
class NurseProfile(models.Model):
    ...
    def __str__(self):
        return f"Nurse: {self.user.get_full_name() or self.user.email}"
